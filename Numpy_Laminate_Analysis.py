...
__all__ = ["chop", "T_Matrix", "R_Matrix", "Poissons_Ratio", "get_Elastic_Constants", "Material", "Iso_Material",
...
class Iso_Material(Material):
    def __init__(self, E, G=None, v=None):
        ...
        super().__init__(E1, E2, G1, G2, v12, v21)
...
class Ply(object):
    ...
    def get_S(self, theta=0., strain_type="Engineering"):
        ...
        compliance = chop(np.matrix([[1 / self.E11, -self.v21 / self.E22, 0], [-self.v12 / self.E11, 1 / self.E22, 0],
...
class GSCS_Ply(Ply):
    def __init__(self, fiber, matrix, Vf):
        ...
        # Fiber Properties
        (Eaf, Etf, Gaf, Gtf, vaf, vtf, cf) = (fiber.E1, fiber.E2, fiber.G1, fiber.G2, fiber.v12, fiber.v21, Vf)
        kf = (Eaf * Etf / (2 * Eaf - 4 * Etf * vaf ** 2 - 2 * Eaf * vtf))
        etaf = (3 - 4 * 1 / 2 * (1 - Gtf / kf))

        # Matrix Properties
        (Eam, Etm, Gam, Gtm, vam, vtm, cm) = (matrix.E1, matrix.E2, matrix.G1, matrix.G2, matrix.v12, matrix.v21, 1 - Vf)
        ...
        # call parent constructor with simplified arguments
        super().__init__(Eac, Etc, Gac, vac, Poissons_Ratio(vac, Eac, Etc))
...
class Ortho_Ply(Ply):
    def __init__(self, E11, E22, G12, v12=None, v21=None):
        ...
        # call parent constructor with simplified arguments
        super().__init__(E11, E22, G12, v12, v21)
...
class Laminate(object):
    def __init__(self, Plies, Layup, t_Plies=None, strain_type="Engineering"):
        ...
        (E11, E22, G12, v12, v21) = get_Elastic_Constants(chop(self.A.I*self.t),
